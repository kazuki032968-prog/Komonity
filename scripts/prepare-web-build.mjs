...
const sitemapPaths = [
  ...
  { path: "/for-advisors", priority: "0.9", changefreq: "weekly" },
  { path: "/for-coaches", priority: "0.9", changefreq: "weekly" },
  { path: "/coach-marketing", priority: "0.8", changefreq: "weekly" },
  { path: "/practice-menu-search", priority: "0.9", changefreq: "weekly" },
  { path: "/practice-menu/soccer", priority: "0.8", changefreq: "weekly" },
  { path: "/practice-menu/baseball", priority: "0.8", changefreq: "weekly" },
  { path: "/practice-menu/basketball", priority: "0.8", changefreq: "weekly" },
  { path: "/practice-menu/tennis", priority: "0.8", changefreq: "weekly" },
  { path: "/practice-menu/brass-band", priority: "0.8", changefreq: "weekly" },
  { path: "/practice-menu/rainy-day", priority: "0.8", changefreq: "weekly" },
  { path: "/practice-menu/60-minutes", priority: "0.8", changefreq: "weekly" },
  { path: "/practice-menu/beginner", priority: "0.8", changefreq: "weekly" },
  { path: "/practice-menu/tournament-prep", priority: "0.8", changefreq: "weekly" },
  { path: "/features", priority: "0.8", changefreq: "weekly" },
  { path: "/features/practice-menu-template", priority: "0.8", changefreq: "weekly" },
  { path: "/features/today-practice-menu-search", priority: "0.8", changefreq: "weekly" },
  { path: "/features/coach-profile", priority: "0.8", changefreq: "weekly" },
