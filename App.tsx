...
import { KomonityLogo } from "./src/components/shared";
import {
...
import { PostComposeScreen } from "./src/screens/PostComposeScreen";
import { PostDetailScreen } from "./src/screens/PostDetailScreen";
import { ReplyDetailScreen } from "./src/screens/ReplyDetailScreen";
...
import { UserActionMenuModal } from "./src/components/profile/UserActionMenuModal";
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      {currentScreen === "post-detail" ? (
        <PostDetailScreen
          ...
          onTogglePostInteraction={(payload) => {
            void togglePostInteraction(payload);
          }}
      ...
      <AppModals
        ...
        onCloseBadgeModal={() => setBadgeModalState(INITIAL_BADGE_MODAL_STATE)}
        onCloseExternalLink={closeExternalLinkModal}
        onConfirmExternalLink={() => {
          void confirmOpenExternalUrl();
        }}
      />
      ...
      {currentScreen === "search" ? (
        <SearchScreen
          ...
          onOpenUserProfile={openUserProfile}
          onOpenPostDetail={openPostDetail}
          onToggleFollowProfile={(payload) => {
            void toggleFollowProfile(payload);
          }}
          onToggleExpandedBody={toggleExpandedBody}
          onOpenExternalUrl={requestOpenExternalUrl}
        />
      ...
      {currentScreen === "mypage" ? (
        <MyPageScreen
          ...
          onOpenPostDetail={openPostDetail}
          onToggleExpandedBody={toggleExpandedBody}
          onTogglePinnedPost={(post) => {
            void togglePinnedPost(post);
          }}
        />
      ) : null}
