...
const colorReplacementByProperty: Record<string, Record<string, string>> = {
  ...
  backgroundColor: {
    ...
    "rgba(255,255,255,0.92)": "#1e293b",
    "rgba(255,255,255,0.7)": "rgba(30, 41, 59, 0.72)",
    "rgba(255,255,255,0.18)": "rgba(30, 41, 59, 0.5)",
    ...
    "#f7fafc": darkTheme.surfaceElevated,
    "#fcf7ee": darkTheme.surfaceElevated,
    "#fffaf0": "#1f2937",
    "#fff7ed": darkTheme.brandSoft,
    "#fff1c7": darkTheme.brandSoft,
    "#fff0dc": darkTheme.brandSoft,
    "#fff4ea": darkTheme.brandSoft,
    "#fff8de": darkTheme.brandSoft,
    "#ffe4b8": darkTheme.brandSoft,
  ...
  borderColor: {
    ...
    "#ef4444": "#f87171",
    "rgba(209, 213, 219, 0.9)": "rgba(148, 163, 184, 0.45)",
    "rgba(255,255,255,0.7)": "rgba(148, 163, 184, 0.32)",
    "rgba(255,255,255,0.65)": "rgba(148, 163, 184, 0.32)",
...
const darkStyleOverrides: Record<string, Partial<StyleRecord>> = {
  ...
  timelineSectionChipActive: {
    ...
    boxShadow: "0 14px 28px rgba(20, 184, 166, 0.26)",
  },
